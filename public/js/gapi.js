   ...
   */
    ...
    var H = function (a, b, c) {
        ...
        L = function (a, b, c) {
            b &&
                0 < b.length &&
                ((b = K(b)),
                c && 0 < c.length && (b += "___" + K(c)),
                28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
                (c = b),
                (b = q(ha, "_p", v())),
                (q(b, c, v())[a] = new Date().getTime()),
                H(a, "_p", c));
        },
        K = function (a) {
            return a
    ...
    var U = decodeURI("%73cript"),
        ...
        X = function () {
            var a = C.nonce;
            return void 0 !== a
                ? a && a === String(a) && a.match(V)
                    ? a
                    : (C.nonce = null)
                : n.querySelector
                ? (a = n.querySelector("script[nonce]"))
        ...
        ta = function (a) {
            ...
            b.async = "true";
            (a = n.getElementsByTagName(U)[0])
                ? a.parentNode.insertBefore(b, a)
                : (n.head || n.body || n.documentElement).appendChild(b);
        },
        va = function (a, b) {
            var c = b && b._c;
            if (c)
        ...
        za = function (a, b) {
            ...
            if (e["::"] && b.length) {
                ...
                for (; (b = a.shift()); ) ya(b.features, c, b.hint);
            } else ya(b || [], c, d);
        },
        ya = function (a, b, c) {
            a = da(a) || [];
...
gapi.load("", {
    ...
    _c: {
        jsl: {
            ...
            h:
                "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.RrjSsKk8Szw.O/am\u003dAQ/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCPwd_oodKkRT_hYRO1I-9xRcQV4oQ/m\u003d__features__",
